...
export class Refactor1684162283336 implements MigrationInterface {
    name = 'Refactor1684162283336'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`key\` int NOT NULL AUTO_INCREMENT, \`id\` varchar(36) NOT NULL, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`version\` int NOT NULL DEFAULT '1', \`deleted\` tinyint NOT NULL DEFAULT 0, \`userName\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_a3ffb1c0c8416b9fc6f907b743\` (\`id\`), UNIQUE INDEX \`IDX_8bf09ba754322ab9c22a215c91\` (\`userId\`), PRIMARY KEY (\`key\`)) ENGINE=InnoDB`);
    }
