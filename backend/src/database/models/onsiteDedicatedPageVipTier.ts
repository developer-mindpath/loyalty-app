...
@Entity({ name: "onsite_dedicated_page_vip_tier" })
export class OnsiteDedicatedPageVipTierModel extends ModelTemplate {
  ...
  @ManyToOne(
    () => AdminUserModel,
    (adminUser) => adminUser.onsiteDedicatedPageVipTier
  )
  @JoinColumn({ name: "admin_ref", referencedColumnName: "id" })
  adminUser: AdminUserModel;

  @ManyToOne(() => UserModel, (user) => user.onsiteDedicatedPageVipTier)
