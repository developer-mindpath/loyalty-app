...
interface IVIPTierprops {
  setPage: (value: string) => void;
  loggedIn: boolean;
}
const VIPTiers = ({ setPage, loggedIn }: IVIPTierprops) => {
  // const { config } = useContext(ConfigContext);
  const config = {
    textsTitle: "000000", // Example: "000000", "FFFFFF", "FF00FF"
    textsDescription: "888888", // Example: "888888", "AAAAAA", "00FFFF"
    tiersTitle: "VIP Tiers", // Example: "VIP Tiers", "Membership Levels", "Reward Tiers"
    tiersSubtitle: "Earn points to unlock exclusive benefits", // Example: "Earn points to unlock exclusive benefits", "Climb the tiers and enjoy special rewards", "Achieve higher tiers for more perks"
