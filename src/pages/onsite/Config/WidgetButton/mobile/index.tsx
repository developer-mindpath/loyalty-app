...
export const MobileWidgetButton = () => {
  const widgetButton = useAppSelector(getWidgetButtonSetting);
  const dispatch = useAppDispatch();
  const {
    mobile_placement,
    mobile_padding_side_padding,
    mobile_padding_bottom_padding,
    mobile_widget_button_type,
    mobile_widget_button_shape,
  } = widgetButton;
  ...
  const handlePaddingSide = useCallback((value: string) => {
    dispatch(
      floatingWidget.setWidgetButton({
        ...widgetButton,
        mobile_padding_side_padding: parseInt(value),
      })
    );
  }, []);
  const handlePaddingBottom = useCallback((value: string) => {
    dispatch(
      floatingWidget.setWidgetButton({
        ...widgetButton,
        mobile_padding_bottom_padding: parseInt(value),
      })
    );
  }, []);
  ...
  const handleType = useCallback((value: string) => {
    dispatch(
      floatingWidget.setWidgetButton({
        ...widgetButton,
        mobile_widget_button_type: value,
      })
    );
  }, []);
  ...
  const handleRadius = useCallback((value: string) => {
    dispatch(
      floatingWidget.setWidgetButton({
        ...widgetButton,
        mobile_widget_button_shape: value,
      })
    );
  }, []);
  ...
  const handleDropZoneDrop = useCallback(
    (_dropFiles: File[], acceptedFiles: File[], _rejectedFiles: File[]) => {
      ...
      //     floatingWidget.setWidgetButton({
      //       ...widgetButton,
      //       mobile_widget_icon: acceptedFiles[0],
      //     })
      //   );
    },
    []
  ...
  return (
    <>
      ...
      <TextField
        ...
        label="Side Padding"
        type="number"
        value={mobile_padding_side_padding + ""}
      ...
      <TextField
        ...
        type="number"
        value={mobile_padding_bottom_padding + ""}
      ...
      <Select
        ...
        options={typeOptions}
        onChange={handleType}
        value={mobile_widget_button_type}
      />
      <Text variant="bodyMd" as="p" color="subdued">
        Customize your widget button type to match your brand.
      </Text>
      <br />
      {(mobile_widget_button_type === "icontext" ||
        mobile_widget_button_type === "text") && (
        <TextField
          autoComplete="off"
          label="Text"
          type="text"
      ...
      <Select
        ...
        value={mobile_widget_button_shape}
      />
      <Text variant="bodyMd" as="p" color="subdued">
...
export default MobileWidgetButton;
