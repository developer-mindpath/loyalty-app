...
import { getWidgetButtonSetting, getWidgetSettings, getWidgetTextSettings } from "@/redux/reducers/floatingWidget";
...
const Widget = () => {
  ...
  const config = {
    launcherPadding:widgetButton.desktop_padding_side_padding,
    widgetRadius: widgetButton.desktop_widget_button_shape,
    fontPrimary: widget.widget_font_primary_font,
    fontSecondary: widget.widget_font_secondary_font,
    customCSS: widget.widget_custom_css,
    textsTitle: widgetText.visitor_header_text_title,
    joinBlockTitle: widgetText.visitor_account_creation_text_title,
    buttonsRadius: widget.widget_corner_shape_button ,
    buttonBg: widget.widget_color_button_background,
    buttonColor: widget.widget_color_button_text,
    joinBlockButtonText: widgetText.visitor_account_creation_button_create_account_text,
    textsDescription: widgetText.visitor_header_text_caption,
    joinBlockFooterText: widgetText.visitor_account_creation_text_signin,
    linkColor: widget.widget_color_others_link_color,
    panelsOrder: ["Earn Points", "Referral Program", "VIP Tiers"],
    iconColor: widget.widget_color_others_icon_color,
    showBranding : widget.widget_brandlift_branding,
  };
