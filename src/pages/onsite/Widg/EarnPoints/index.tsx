...
interface IEarnPoints {
  setPage: (value: string) => void;
  loggedIn: boolean;
}

const EarnPoints = ({ setPage, loggedIn }: IEarnPoints) => {
  ...
  const config = {
    ...
    earnTitle: widgetText.visitor_points_text_title,
    textsDescription: widget.widget_color_text_description,
    earnSubtitle: widgetText.visitor_points_text_description,
    iconColor: widget.widget_color_others_icon_color,
    earnButton1: "Ways to earn",
    earnButton2: "Ways to redeem",
  };
